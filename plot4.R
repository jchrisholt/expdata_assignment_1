...
hpc_cleaned$Voltage <- as.numeric(hpc_cleaned$Voltage)
...
# top right graph
plot(hpc_cleaned$dt, hpc_cleaned$Voltage, type = "l",
     ylab = "Voltage",
     xlab = "datetime")
...
# bottom right graph
plot(hpc_cleaned$dt, hpc_cleaned$Global_reactive_power, type = "l", xlab = "datetime", 
